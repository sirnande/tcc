...
*/
package edu.br.utfpr.autho;

import edu.br.utfpr.builder.ServiceBuilder;
import edu.br.utfpr.builder.api.LinkedInApi;
import edu.br.utfpr.model.OAuthRequest;
import edu.br.utfpr.model.Response;
import edu.br.utfpr.model.Token;
import edu.br.utfpr.model.Verb;
import edu.br.utfpr.oauth.OAuthService;
...
public class Main {
    ...
    private static String API_KEY = "78txb9hqxdll9c";
    private static String API_SECRET = "3VWcH9WtcN3Djj7W";
    private static String ACCESS_TOKEN_VALUE = null;
    private static String TOKEN_SECRET_VALUE = null;
        ...
        try{
            ...
            if(file.exists()){
              ...
              //  System.out.println("There is no stored Access token we need to make one");
                System.err.println("Não há token de acesso armazenado que precisamos fazer um");
                //In the constructor the AuthHandler goes through the chain of calls to create an Access Token
                //No construtor, o AuthHandler passa pela cadeia de chamadas para criar um token de acesso
...
*/
       ...
       url = "http://api.linkedin.com/v1/people-search:(people:(first-name,last-name,headline),facets:(code,buckets))";
        //url = "http://api.linkedin.com/v1/people-search:(people:(francisco,xavier,headline),facets:(code,buckets))";
...
*/
       ...
       // url = "https://api.linkedin.com/v1/people/~/connections:(francisco,xavier,49836710b)?format=json";
        System.out.println(url);
...
/*
        ...
        System.out.println("************   pesquisar de pessoas *********************");
        ACCESS_TOKEN_VALUE = accessToken.getToken();
        TOKEN_SECRET_VALUE = accessToken.getSecret();
        
        PeopleApiClient linkedin = authentication();

        searchParameters.put(SearchParameter.COMPANY_NAME, "UTFPR");
        ...
        */
        ...
        // help in the forums.
        url = "https://api.linkedin.com/v1/people/francisco-xavier";
 ...
 /*   
    private static PeopleApiClient authentication() {
        ...
        final LinkedInApiClientFactory factory = LinkedInApiClientFactory.newInstance(API_KEY, API_SECRET);
